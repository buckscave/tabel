...
/* Konversi warna TABEL ke PDF RGB (inverse mode) */
static void warna_ke_pdf_rgb(warna_glyph warna, double *r, double *g, double *b) {
    /* Mode inverse: background putih, jadi warna gelap untuk teks */
    switch (warna) {
        case WARNA_GELAP:
        case WARNA_ABU:
            *r = 0.3; *g = 0.35; *b = 0.4;
            break;
        case WARNA_PUTIH:
            *r = 0.0; *g = 0.0; *b = 0.0;  /* Hitam di PDF */
            break;
        case WARNA_HIJAU:
            *r = 0.0; *g = 0.5; *b = 0.0;
            break;
        ...
        case WARNA_MERAH:
            *r = 0.8; *g = 0.0; *b = 0.0;
            break;
        case WARNA_BG_HIJAU:
        case WARNA_BG_HIJAU_GELAP:
        case WARNA_BG_HIJAU_TUA:
            *r = 0.0; *g = 0.4; *b = 0.0;
            break;
        case WARNA_BG_KUNING:
            *r = 0.7; *g = 0.5; *b = 0.0;
            break;
        case WARNA_BG_BIRU:
            *r = 0.0; *g = 0.4; *b = 0.4;
...
static void cb_text(struct content_builder *cb, double x, double y,
                    const char *teks, double font_size, double r, 
                    double g, double b) {
...
static void render_isi_sel(struct content_builder *cb,
    ...
    warna = buf->warna_teks_sel[baris][kolom];
    ...
    /* Konversi warna (inverse mode) */
    warna_ke_pdf_rgb(warna, &r, &g, &b);
    ...
    cb_text(cb, x + x_offset, y - cfg->ukuran_font, teks, cfg->ukuran_font,
            r, g, b);
}
...
static void render_border(struct content_builder *cb,
    ...
    for (c = kolom_mulai; c <= kolom_akhir; c++) {
        ...
        for (r = baris_mulai; r <= baris_akhir; r++) {
            ...
            /* Konversi warna border */
            warna_ke_pdf_rgb(border->warna, &br, &bg, &bb);

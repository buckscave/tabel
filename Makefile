...
formula/statistik.o: formula/statistik.c $(HEADER)
formula/keuangan.o: formula/keuangan.c $(HEADER)
formula/logika.o: formula/logika.c $(HEADER)
formula/pencarian.o: formula/pencarian.c $(HEADER)
formula/konversi.o: formula/konversi.c $(HEADER)
